<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ModeratorWebForm.aspx.cs" Inherits="Project_Glados_master.ModeratorWebForm" %>
    ...
    <div style="margin: auto; align-items: center">
        <form id="form2" runat="server">
            ...
            <div style="text-align:center">
                ...
                <asp:Button ID="RequestGame" runat="server" OnClick="RequestGame_Click" Text="Request Game" />
            </div>

            <br />

            <div>
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ProjectGladosDBConnectionString2 %>" SelectCommand="SELECT TOP 10 [VideoGameId], [Title], [Price], [Genre], [Company], [Rating] FROM [VideoGames] WHERE Requested = 0">
                </asp:SqlDataSource>
